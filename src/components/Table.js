  ...
  render() {
    ...
    return (
      <div className="table">
        ...
        <Card tablePosition= "1" currentActivation={this.state.openCardNumber} position={position}/>
        <Card tablePosition= "2" currentActivation={this.state.openCardNumber} position={position}/>
        <Card tablePosition= "3" currentActivation={this.state.openCardNumber} position={position}/>
        <div openingcard="3" className="selectButton" style={{left:112}} onClick={(e) => {this.updateOpenCardNumber(e)}}> </div>
        <div className="marge"> </div>
        <Card tablePosition= "4" currentActivation={this.state.openCardNumber} position={position}/>
        <div openingcard="4" className="selectButton" style={{left:167}} onClick={(e) => {this.updateOpenCardNumber(e)}}> </div>
        <div className="marge"> </div>
        <Card tablePosition= "5" currentActivation={this.state.openCardNumber} position={position}/>
